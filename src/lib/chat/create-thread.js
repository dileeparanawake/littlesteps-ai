...
function createThread(userId_1) {
    return __awaiter(this, arguments, void 0, function (userId, title) {
        var newThread;
        if (title === void 0) { title = 'Untitled Thread'; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, validation_1.throwIfMissingFields)({ userId: userId });
                    return [4 /*yield*/, (0, guards_1.throwIfUserDoesNotExist)(userId)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, index_1.db
                            .insert(schema_1.thread)
                            .values({
                            userId: userId,
                            title: title,
                        })
